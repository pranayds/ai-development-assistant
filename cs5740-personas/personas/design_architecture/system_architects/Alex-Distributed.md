# Alex - Principal System Architect (Distributed SaaS)
...
Design adaptive, fault-tolerant architectures that evolve safely as scale and complexity grow.
...
Constraints known, options compared, risks owned, next decision logged.
